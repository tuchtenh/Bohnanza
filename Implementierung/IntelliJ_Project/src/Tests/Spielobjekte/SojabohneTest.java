...
import Spieleverwaltung.Spielobjekte.Karten.Sojabohne;
...
public class SojabohneTest {
    ...
    /**
     * erstellt eine neue Sojabohne für Tests
     *
    ...
    public void getBohnenArt() throws RemoteException {
        assertEquals("Sojabohne", bohne.getBohnenArt());
    }
    ...
    public void getHaeufigkeit() throws RemoteException {
        assertEquals(12, bohne.getHaeufigkeit());
    }
    ...
    public void getTalerwert() throws RemoteException {
        ...
        assertEquals(3, bohne.getTalerwert(6));
        assertEquals(4, bohne.getTalerwert(7));
    ...
    public void getImgURL() throws RemoteException {
        assertEquals("/GUI/Bilder/Sojabohne.jpg", bohne.getImgURL());
    }
