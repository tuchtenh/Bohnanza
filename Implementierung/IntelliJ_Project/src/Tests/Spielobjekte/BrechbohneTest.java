...
public class BrechbohneTest {
    ...
    /**
     * erstellt eine neue Brechbohne für Tests
     *
     * @throws RemoteException wenn bei Verbindung zum Server etwas schiefläuft
     */
    @BeforeClass
    public static void beforeClass() throws RemoteException {
        bohne = new Brechbohne();
    }
    ...
    public void getBohnenArt() throws RemoteException {
        assertEquals("Brechbohne", bohne.getBohnenArt());
    }
    ...
    public void getHaeufigkeit() throws RemoteException {
        assertEquals(14, bohne.getHaeufigkeit());
    }
    ...
    public void getImgURL() throws RemoteException {
        assertEquals("/GUI/Bilder/Brechbohne.jpg", bohne.getImgURL());
    }
